...
def render_blog_landing_article(items: list[FeedItem]) -> str:
    ...
    return (
        ...
        '<form action="https://app.kit.com/forms/9514147/subscriptions" class="seva-form" method="post" data-sv-form="9514147" data-uid="67af2df661" data-format="inline" data-version="5">'
        '<div class="flex gap-3">'
        '<input class="flex-1 bg-slate-800 border border-slate-600 text-slate-100 placeholder-slate-400 px-4 py-3 text-sm focus:outline-none focus:border-cyan-400 transition-colors" name="email_address" type="email" placeholder="Your email address" required />'
        '<button type="submit" class="bg-primary hover:bg-white text-navy-deep px-6 py-3 text-xs font-bold uppercase tracking-widest transition-all whitespace-nowrap">Subscribe</button>'
        '</div>'
